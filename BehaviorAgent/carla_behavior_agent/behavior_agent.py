...
class BehaviorAgent(BasicAgent):
    ...
    def _iam_stuck(self, waypoint):
        ...
        vehicle_list = [v for v in vehicle_list if dist(v) < 30 and v.id != self._vehicle.id and ( (abs(self._map.get_waypoint(v.get_transform().location).lane_id) == abs(ego_wpt.lane_id) + 1))]
