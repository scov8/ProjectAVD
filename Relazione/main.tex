...
\begin{verbatim}
    ...
    "infractions": {
        ...
        "collisions_pedestrian": [],
        "collisions_vehicle": [
            "Agent collided against object with type=vehicle.chevrolet.impala
            and id=35521 at (x=-3087.486, y=619.79, z=320.53)"
        ],
        "red_light": [],
        "stop_infraction": [
            "Agent ran a stop with id=31917 at (x=-3084.022, y=615.53, z=320.273)"
        ],
        "outside_route_lanes": [
            "Agent went outside its route lanes for about 5.066 meters
            (0.16% of the completed route)"
        ],
        "min_speed_infractions": [
            "Average speed is 90.9% of the surrounding traffic's one",
            "Average speed is 94.6% of the surrounding traffic's one",
            "Average speed is 98.81% of the surrounding traffic's one",
            "Average speed is 98.81% of the surrounding traffic's one"
        ],
        "yield_emergency_vehicles_infractions": [],
        "scenario_timeouts": [],
    ...
    "scores": {
        "score_route": 100,
        "score_penalty": 0.455329,
        "score_composed": 45.532881
    },
    "meta": {
        "route_length": 3206.913,
        "duration_game": 434.15,
        "duration_system": 821.393
    }
}
\end{verbatim}
\clearpage
...
\begin{verbatim}
    ...
    "meta": {
        "route_length": 884.393,
        "duration_game": 232.45,
        "duration_system": 365.14
    }
}
\end{verbatim}
\clearpage
...
\begin{verbatim}
    ...
    "meta": {
        "route_length": 1231.288,
        "duration_game": 376.75,
        "duration_system": 627.647
    }
}
\end{verbatim}
\clearpage
...
\begin{verbatim}
    ...
    "infractions": {
        "collisions_layout": [
            "Agent collided against object with type=traffic.stop and id=44393
            at (x=3610.803, y=2521.817, z=363.886)"
        ],
        "collisions_pedestrian": [
            "Agent collided against object with type=walker.pedestrian.0049
            and id=47477 at (x=3591.484, y=2405.555, z=361.443)",
            "Agent collided against object with type=walker.pedestrian.0049
            and id=47477 at (x=3591.484, y=2405.555, z=361.443)"
        ],
        "collisions_vehicle": [],
        ...
        "stop_infraction": [],
        "outside_route_lanes": [
            "Agent went outside its route lanes for about 5.0 meters
            (0.56% of the completed route)"
        ],
        "min_speed_infractions": [],
        "yield_emergency_vehicles_infractions": [],
        "scenario_timeouts": [],
    ...
    "scores": {
        "score_route": 100,
        "score_penalty": 0.161589,
        "score_composed": 16.158952
    },
    "meta": {
        "route_length": 900.445,
        "duration_game": 268.7,
        "duration_system": 401.493
    }
}
\end{verbatim}
